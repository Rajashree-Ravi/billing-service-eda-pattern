...
public class KafkaConfiguration {
	...
	@Bean
	public ProducerFactory<String, BillDto> producerFactoryString() {
	...
	@Bean
	public KafkaTemplate<String, BillDto> kafkaTemplateString() {
	...
	public ConsumerFactory<String, OrderDto> consumerFactory() {
		...
		configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.ecommerce.billingservice.model.OrderDto");
